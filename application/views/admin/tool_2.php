  ...
  <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab"> -->
    <div class="row">
      ...
      <div class="col-lg-8">
        ...
        <div class="row">
          ...
          <div class="col-lg-8">
            ...
            <textarea  type="text" placeholder="Isi Keyword Utama" cols="89"  style="border-color: #c0c0c0;height: 38px;padding-left: 10px;padding-top: 10px;color: #c0c0c0"></textarea>
      ...
      <div class="col-lg-4">
        ...
        <p class="mt-4" style="font-weight: 600;">Rekomendasi Keyword</p>
