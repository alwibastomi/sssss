            ...
            <div class="bg-teal rounded overflow-hidden">
              <div class="pd-25 d-flex align-items-center">
                ...
                <div class="mg-l-20">
                  ...
                  <span class="tx-11 tx-roboto tx-white-6">24% Higher bulan wingi</span>
                </div>
              </div>
            </div>
          </div><!-- col-3 -->
          <div class="col-sm-6 col-xl-3 mg-t-20 mg-sm-t-0">
            <div class="bg-danger rounded overflow-hidden">
              <div class="pd-25 d-flex align-items-center">
                <i class="ion ion-arrow-up-a tx-60 lh-0 tx-white op-7"></i>
                <div class="mg-l-20">
                  <p class="tx-10 tx-spacing-1 tx-mont tx-medium tx-uppercase tx-white-8 mg-b-10">User Aktif</p>
                  <p class="tx-24 tx-white tx-lato tx-bold mg-b-2 lh-1">729,291</p>
                  <span class="tx-11 tx-roboto tx-white-6">10% Higher bulan wingi</span>
                </div>
              </div>
            </div>
          </div><!-- col-3 -->
          <div class="col-sm-6 col-xl-3 mg-t-20 mg-xl-t-0">
            <div class="bg-primary rounded overflow-hidden">
              <div class="pd-25 d-flex align-items-center">
                <i class="ion ion-arrow-up-a tx-60 lh-0 tx-white op-7"></i>
                <div class="mg-l-20">
                  <p class="tx-10 tx-spacing-1 tx-mont tx-medium tx-uppercase tx-white-8 mg-b-10">Penjualan</p>
                  <p class="tx-24 tx-white tx-lato tx-bold mg-b-2 lh-1">$729,291</p>
                  <span class="tx-11 tx-roboto tx-white-6">$390,212 total kemarin</span>
                </div>
              </div>
            </div>
          </div><!-- col-3 -->
          <div class="col-sm-6 col-xl-3 mg-t-20 mg-xl-t-0">
            <div class="bg-br-primary rounded overflow-hidden">
              <div class="pd-25 d-flex align-items-center">
                <i class="ion ion-arrow-up-a tx-60 lh-0 tx-white op-7"></i>
                <div class="mg-l-20">
                  <p class="tx-10 tx-spacing-1 tx-mont tx-medium tx-uppercase tx-white-8 mg-b-10">Ulang/perpanjang</p>
                  <p class="tx-24 tx-white tx-lato tx-bold mg-b-2 lh-1">92.16%</p>
                  <span class="tx-11 tx-roboto tx-white-6">65.45% Higher bulan wingi</span>
                </div>
              </div>
            </div>
          </div><!-- col-3 -->
