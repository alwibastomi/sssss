<div class="br-header">
  ...
  <div class="br-header-right">
    ...
    <div class="navicon-right">
      <a id="" href="" alt="logout" class="pos-relative"  data-toggle="modal" data-target="#modaldemo2">
  ...
  <div class="modal-dialog modal-sm" role="document">
    <div class="modal-content bd-0 tx-14">
      ...
      <div class="modal-body pd-20">
        <p class="mg-b-5">Tenan metu?. </p>
      </div>
      <div class="modal-footer justify-content-center">
        <a href="<?= site_url('Login/logout') ?>" class="btn btn-primary tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium">Getun</a>
        <button type="button" style="cursor: pointer" class="btn btn-secondary tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium" data-dismiss="modal">Mbalek</button>
      </div>
    </div>
  </div><!-- modal-dialog -->
</div><!-- modal -->
